...
def main(args):
    ...
    for video_name in tqdm.tqdm(list(anno_database.keys())):
        file_path = os.path.join(
            args.data_dir, f"{args.prefix}{video_name}{args.suffix}.{args.ext}"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "anno_file", metavar="FILE", type=str, help="path to annotation"
    )
    parser.add_argument(
        "data_dir", metavar="FILE", type=str, help="path to data folder"
    )
