...
annotation_path = "data/annotations/thumos_14_anno.json"
class_map = "data/annotations/category_idx.txt"
data_path = "data/features/i3d_actionformer_stride4_thumos/"
